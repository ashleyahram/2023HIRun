...
void HLTEffAnalyzer(
    ...
    if(tag == "TEST") {
      ...
      paths = { "/eos/cms/store/group/phys_heavyions/soohwan/Run3_2023/./PostRunHLT/TriggerStudy_Run375754_DetailedForMu_PbPb2023_CMSSW_13_2_6_patch2_soohwan_09Nov2023_v1/ntuple.root" }; // events
        ...
        for (unsigned irun = 0; irun < Runs_bin.size(); ++irun) {
            ...
            for (unsigned ieta = 0; ieta < Etas_bin.size(); ++ieta) {
                ...
                for (auto& Eff_genpt_min: Eff_genpt_mins) {
                    ...
                    HistContainer* hc_tmp1_2 = new HistContainer( TString::Format("Eff_L1SQ0_%s_%s_%s_genpt%.0f", L3type.Data(), run_str.Data(), Etas_str.at(ieta).Data(), Eff_genpt_min) );
                    ...
                    HistContainer2D* hc2D_tmp1 = new HistContainer2D( TString::Format("2DEff_L1SQ0_%s_%s_%s_genpt%.0f", L3type.Data(), run_str.Data(), Etas_str.at(ieta).Data(), Eff_genpt_min) );
                    HistContainer2D* hc2D_tmp2 = new HistContainer2D( TString::Format("2DEff_L1DQ0_%s_%s_%s_genpt%.0f", L3type.Data(), run_str.Data(), Etas_str.at(ieta).Data(), Eff_genpt_min) );
                    ...
                    hc_Eff_L1SQ0.at(iL3type).at(irun).at(ieta).push_back( hc_tmp1_2 );
                    ...
                    hc2D_Eff_L1SQ0.at(iL3type).at(irun).at(ieta).push_back( hc2D_tmp1 );
                    hc2D_Eff_L1DQ0.at(iL3type).at(irun).at(ieta).push_back( hc2D_tmp2 );
    ...
    for(unsigned i_ev=0; i_ev<nEvent; i_ev++) {
        ...
        // -- TnP selection
        vector<Object> muons = nt->get_offlineMuons(); //get muons' information
                      ...
                      // cout << "probemu: " << probemu << endl;
                        ...
                        */
                        ...
                        // }
                             ...
                             if (nt->path_fired("HLT_HIL3SingleMu12_v3")) matched_idx = probemu.matched( *L3Coll, L3map, 0.1 );
